...
//		System.out.println("요금제:"+divAdole);
		...
		2. 삼항연산자
			조건문|논리연산식?true일때처리할데이터:false일때처리할데이터;
			int age = sc.nextInt();
		...
		//     그외는 "일반사은품"이라고 사은품을 구분하여 할당
		//     되게 하세요..
		Scanner sc2 = new Scanner(System.in);
		System.out.print("구매할 물건의 가격:");
		int buyPrice = sc2.nextInt();
		System.out.print("구매할 물건의 갯수:");
		int buyCnt = sc2.nextInt();
