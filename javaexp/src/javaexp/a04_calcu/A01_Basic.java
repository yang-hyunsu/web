...
public class A01_Basic {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("나머지 빵의 갯수:"+(breadCnt%bearCnt));
		// ex2) 사과가 단가가 2000원 하는 것을 5개 구매하였다. 총비용을
		//      출력하세요..
		int applePrice = 2000;
		int buyCnt = 5;
		int totPay = applePrice*buyCnt;
		System.out.println("사과의 단가:"+applePrice);
		System.out.println("구매 갯수:"+buyCnt);
		System.out.println("총비용:"+totPay);
		// ex3) 현재 지갑속에 20000원이 있는데, 
		//      교통비로 2000원 2번
		...
		int transCnt = 2;
		int foodPay = 7000;
		int totSpend = (transPay*transCnt)+ foodPay;
		inMyPocket -= totSpend;	
		System.out.println("총지출금액:"+totSpend);
