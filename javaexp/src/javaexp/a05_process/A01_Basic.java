...
public class A01_Basic {
	...
	public static void main(String[] args) {
		...
		2.제어문의 역할
		   코드의 실행 흐름을 개발자가 원하는 방향으로 변경할 
		   수 있도록 도와 준다.
		   
		*/
		System.out.println("#순차 구조에 의한 처리 흐름#");
		System.out.println("맛있는 라면 끊이기");
		System.out.println("1. 적정한물과 스프를 넣고 끊인다.");
		System.out.println("1-1. 물인 끊는지 여부 확인(조건문처리)");
		System.out.println("2. 끊고 있으면 라면을 넣는다.");
		System.out.println("3. 계란과 파를 넣는다.");
		System.out.println("4. 넣을 그릇을 준비하여 옮긴다");
