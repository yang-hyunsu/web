...
public class A02_if {
	...
	public static void main(String[] args) {
		...
		//  4개/8개 일때  바나나도 먹었습니다를 추가 처리되게 하세요..
		//     중괄호 블럭 사용..
		int fruCnt = 0;
		System.out.println("곰돌이가 사과를 "+(fruCnt+=2)+"개 먹었다");
		// fruCnt가 4일 때와 8일 때만 수행, 그외는 수행하지 않는다.
		if(fruCnt==4||fruCnt==8) {
			System.out.println("바나나도 먹었습니다1!!");
			System.out.println("바나나도 먹었습니다2!!");
		}
		System.out.println("곰돌이가 사과를 "+(fruCnt+=2)+"개 먹었다");
		if(fruCnt==4||fruCnt==8) {
			System.out.println("바나나도 먹었습니다1!!");
		...
		//      하세요..
		int cntUp = 0;
		System.out.println("카우트 업:"+(++cntUp));
		System.out.println("카우트 업:"+(++cntUp));
		if(cntUp == 3) System.out.println("### "+cntUp+"입니다 ###");
		System.out.println("카우트 업:"+(++cntUp));
		if(cntUp == 3) System.out.println("### "+cntUp+"입니다 ###");
		System.out.println("카우트 업:"+(++cntUp));
		System.out.println("카우트 업:"+(++cntUp));
