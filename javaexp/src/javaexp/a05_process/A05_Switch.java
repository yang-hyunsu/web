...
public class A05_Switch {
	...
	public static void main(String[] args) {
		...
		2. switch라는 구문자체로 볼 수 있듯이 어떤 room에서
			...
			달라지듯이 해당 특정 데이터를 기준으로 처리되는 구문이라고
			할 수 있다.
		3. 기본형식
			switch(변수){
				case 경우1:
				...
				case 경우2:
					...
					벗어나지 않고, 바로 밑에 case내용을 
					수행 처리해 준다.
				case 경우3:
					처리할 내용
					break;
				default:
					위에 나열된 경우1,경우2,경우3이 아닐 때
					처리할 내용
		...
		//   3은 정답처리
		//   1,2,4는 오답 처리
		//   그외 번호를 1~4까지만 가능합니다. 출력..
		// 1. Scanner를 통해서 번호를 입력 받아서 처리
		// 2. switch기본구문에 처리하게.
		//        1
		//        2
		//        3
...
//		System.out.println("입력한 정답:"+chNum);
//		switch(chNum) {
//			case 1:
//			case 2:
//			case 4:
...
//				break;
//			default:
//				System.out.println("답은 1~4번 입력 가능합니다.");
//				break;
//		}
		// ex) 월을 입력받아 해당 월의 마지막 일짜를 출력하세요.
		//     31:1,3,5,7,8,10,12
		//     30:4,6,9,11
		//     28:2
		//     월은 1~12까지 입력하야야 합니다.
